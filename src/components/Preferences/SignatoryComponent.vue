    ...
    <div>
        <div class="card-grid">
            ...
            <div class="card-anim-wrapper" :style="{ animationDelay: `120ms` }" v-if="loading">
                <q-card key="data-add" class="card card-hover-animate fleflex column justify-center items-center no-shadow cursor-pointer radius-sm" >
                    <q-card-section>
        ...
        <q-dialog v-model="dialog" full-height position="right" persistent square class="dialog">
            <q-card class="dialog-card column full-height">
                ...
                <q-card-section class="col q-pa-lg scroll">
                    ...
                    <div v-else>
                        <div class="q-mb-md">
                            <div class="text-caption text-uppercase" :class="Errors.type.msg ? 'text-negative text-italic' : 'text-grey'">{{ Errors.type.msg ? Errors.type.msg : 'document type' }}</div>
                            <div class="q-gutter-sm">
                                <q-radio v-for="value in types" v-model="type" checked-icon="bi-check-circle-fill" unchecked-icon="bi-check-circle" :val="value" :label="value" class="text-capitalize"/>
                            </div>
                        </div>
                        ...
                        <div class="row q-col-gutter-xs q-mb-xs">
                            ...
                            <div class="col-2">
                                <div class="text-caption text-uppercase" :class="Errors.signatories.description.msg ? 'text-negative text-italic' : 'text-grey'">{{ Errors.signatories.description.msg ? Errors.signatories.description.msg : 'description' }}</div>
                            </div>
                            <div class="col-1">
                                <div class="text-caption text-uppercase" :class="Errors.signatories.order.msg ? 'text-negative text-italic' : 'text-grey'">{{ Errors.signatories.order.msg ? Errors.signatories.order.msg : 'order' }}</div>
                            </div>
                        </div>
