        ...
        <div class="row q-col-gutter-xs q-mb-xs">
            <div class="col-3">
                <div class="q-mb-xs">
                    ...
                    <q-icon
                        :name="Errors.trainingMessages?.title?.length ? 'error' : 'info'"
                        :color="Errors.trainingMessages?.title?.length ? 'negative' : 'grey'"
                    ...
                    >
                        <q-tooltip
                            anchor="top middle"
                            self="center middle"
                            :class="Errors.trainingMessages?.title?.length ? 'bg-negative' : 'bg-grey'"
                        >
                            <template v-if="Errors.trainingMessages?.title?.length">
                                <div
                                    v-for="(msg, i) in Errors.trainingMessages.title"
                                    :key="i"
            ...
            <div class="col-1">
                <div class="q-mb-xs">
                    ...
                    <q-icon
                        :name="Errors.trainingMessages?.start?.length ? 'error' : 'info'"
                        :color="Errors.trainingMessages?.start?.length ? 'negative' : 'grey'"
                        class="cursor-pointer"
                        size="xs"
                    >
                        <q-tooltip
                            anchor="top middle"
                            self="center middle"
                            :class="Errors.trainingMessages?.start?.length ? 'bg-negative' : 'bg-grey'"
                        >
                            <template v-if="Errors.trainingMessages?.start?.length">
                                <div
                                    v-for="(msg, i) in Errors.trainingMessages.start"
                                    :key="i"
                                    class="text-capitalize"
                                >
                                    <q-icon name="error" color="white" size="xs" />&nbsp;{{ msg }}
            ...
            <div class="col-1">
                <div class="q-mb-xs">
                    ...
                    <q-icon
                        :name="Errors.trainingMessages?.end?.length ? 'error' : 'info'"
                        :color="Errors.trainingMessages?.end?.length ? 'negative' : 'grey'"
                        class="cursor-pointer"
                        size="xs"
                    >
                        <q-tooltip
                            anchor="top middle"
                            self="center middle"
                            :class="Errors.trainingMessages?.end?.length ? 'bg-negative' : 'bg-grey'"
                        >
                            <template v-if="Errors.trainingMessages?.end?.length">
                                <div
                                    v-for="(msg, i) in Errors.trainingMessages.end"
                                    :key="i"
                                    class="text-capitalize"
                                >
                                    <q-icon name="error" color="white" size="xs" />&nbsp;{{ msg }}
            ...
            <div class="col-1">
                <div class="q-mb-xs">
                    ...
                    <q-icon
                        :name="Errors.trainingMessages?.hour?.length ? 'error' : 'info'"
                        :color="Errors.trainingMessages?.hour?.length ? 'negative' : 'grey'"
                        class="cursor-pointer"
                        size="xs"
                    >
                        <q-tooltip
                            anchor="top middle"
                            self="center middle"
                            :class="Errors.trainingMessages?.hour?.length ? 'bg-negative' : 'bg-grey'"
                        >
                            <template v-if="Errors.trainingMessages?.hour?.length">
                                <div
                                    v-for="(msg, i) in Errors.trainingMessages.hour"
                                    :key="i"
                                    class="text-capitalize"
                                >
                                    <q-icon name="error" color="white" size="xs" />&nbsp;{{ msg }}
            ...
            <div class="col-2">
                <div class="q-mb-xs">
                    ...
                    <q-icon
                        :name="Errors.trainingMessages?.typeId?.length ? 'error' : 'info'"
                        :color="Errors.trainingMessages?.typeId?.length ? 'negative' : 'grey'"
                        class="cursor-pointer"
                        size="xs"
                    >
                        <q-tooltip
                            anchor="top middle"
                            self="center middle"
                            :class="Errors.trainingMessages?.typeId?.length ? 'bg-negative' : 'bg-grey'"
                        >
                            <template v-if="Errors.trainingMessages?.typeId?.length">
                                <div
                                    v-for="(msg, i) in Errors.trainingMessages.typeId"
                                    :key="i"
                                    class="text-capitalize"
                                >
                                    <q-icon name="error" color="white" size="xs" />&nbsp;{{ msg }}
            ...
            <div class="col-2">
                <div class="q-mb-xs">
                    ...
                    <q-icon
                        :name="Errors.trainingMessages?.conductedBy?.length ? 'error' : 'info'"
                        :color="Errors.trainingMessages?.conductedBy?.length ? 'negative' : 'grey'"
                        class="cursor-pointer"
                        size="xs"
                    >
                        <q-tooltip
                            anchor="top middle"
                            self="center middle"
                            :class="Errors.trainingMessages?.conductedBy?.length ? 'bg-negative' : 'bg-grey'"
                        >
                            <template v-if="Errors.trainingMessages?.conductedBy?.length">
                                <div
                                    v-for="(msg, i) in Errors.trainingMessages.conductedBy"
                                    :key="i"
                                    class="text-capitalize"
                                >
                                    <q-icon name="error" color="white" size="xs" />&nbsp;{{ msg }}
...
const LoadTraining = async () => {
    ...
    try {
        const { data } = await api.get(`/employee/training/${EmployeeStore.employment.profileId}`);
